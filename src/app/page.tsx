...
export default function Home() {
  ...
  const confirmAddToTrip = async () => {
    ...
    const defaultLink = addingToTripEntry.links?.[0] || `https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(addingToTripEntry.address || addingToTripEntry.title)}`;
